...
//    private var repoMessage: MessageRepository,
//    private var repoReaction: ReactionRepository,
...
//            repoReaction.addReaction(messageId, emoji)
//                .subscribeOn(Schedulers.io())
//                .observeOn(Schedulers.io())
//                .subscribe(
//                    {
...
//
//        compositeDisposable.add(
//            repoReaction.removeReaction(messageId, emoji)
//                .subscribeOn(Schedulers.io())
//                .observeOn(Schedulers.io())
//                .subscribe(
//                    {
...
//        _viewState.value = MessageViewState.Loading
//
//        compositeDisposable.add(repoMessage.addMessage(
...
//        _viewState.value = MessageViewState.Loading
//
//        compositeDisposable.add(repoMessage.getLocalMessages()
//            .subscribeOn(Schedulers.io())
//            .observeOn(Schedulers.io())
//            .subscribe(
//                {
...
//        )
//
//        val generalMessagesTest = repoMessage.getMessages(
//            streamName = streamTitle,
//            topicName = topicTitle,
