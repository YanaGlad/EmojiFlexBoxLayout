...
class MessageDelegate constructor(
    ...
    private val onEmojiNotClick: (String, Int) -> Unit,
) : AdapterDelegate {
    ...
    override fun onCreateViewHolder(parent: ViewGroup): RecyclerView.ViewHolder =
        UserViewHolder(
            ...
            onEmojiNotClick = onEmojiNotClick,
        )
...
//        }
    ...
    class UserViewHolder(
        ...
        val onEmojiNotClick: (String, Int) -> Unit,
            ...
            binding.message.apply {
                ...
                for (i in 0 until size) {
                    addNewEmoji(
                        ...
                        messageModel.listReactions[i].clicked,
                        { onEmojiClick(emojiIcons[i], messageModel.id) },
                        { onEmojiNotClick(emojiIcons[i], messageModel.id) },
                    )
                }
            }
